...
export const gameStartedEvent = (app: Application) => {
	app.get('/api/startedGamesNotifier', (req: Request, res: Response) => {
...
export const notifyAllGameHasStarted = (gameId: number) => {
